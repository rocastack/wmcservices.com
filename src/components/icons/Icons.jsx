...
export const PremiumPhoneIcon = ({ size = 28, color = "currentColor" }) => (
...
export const PremiumMailIcon = ({ size = 28, color = "currentColor" }) => (
  <svg viewBox="0 0 24 24" width={size} height={size} fill="none" color={color} xmlns="http://www.w3.org/2000/svg">
...
export const PremiumLocationIcon = ({ size = 28, color = "currentColor" }) => (
  <svg viewBox="0 0 24 24" width={size} height={size} fill="none" color={color} xmlns="http://www.w3.org/2000/svg">
